...
namespace API.Migrations
{
    ...
    [Migration("20211015095825_EstimationEntityUpdate")]
    partial class EstimationEntityUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.Projects.Estimation", b =>
                {
                    ...
                    b.Property<float>("Checking")
                        .HasColumnType("REAL");

                    b.Property<DateTime?>("Create")
                        .HasColumnType("TEXT");

                    b.Property<float>("DouglasFirs")
                        .HasColumnType("REAL");
                    ...
                    b.Property<float>("GPFrames")
                        .HasColumnType("REAL");

                    b.Property<float>("Issuing")
                        .HasColumnType("REAL");

                    b.Property<float>("Other")
                        .HasColumnType("REAL");

                    b.Property<float>("Panels")
                        .HasColumnType("REAL");
                    ...
                    b.Property<float>("Sections")
                        .HasColumnType("REAL");

                    b.Property<float>("Slab")
                        .HasColumnType("REAL");
            ...
            modelBuilder.Entity("API.Models.Projects.Estimation", b =>
                {
                    b.HasOne("API.Models.Users.AppUser", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId");

                    b.HasOne("API.Models.Users.AppUser", "Editor")
                        .WithMany()
                        .HasForeignKey("EditorId");

                    b.HasOne("API.Models.Projects.Project", "Project")
                        .WithOne("Estimation")
                        .HasForeignKey("API.Models.Projects.Estimation", "ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
